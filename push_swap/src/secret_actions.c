...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/15 14:38:01 by lmattern          #+#    #+#             */
/*   Updated: 2023/12/21 15:26:46 by lmattern         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
void	replace_values(t_stack_node **a, t_stack_node **s_stack, size_t a_size)
{
	...
	while (i < a_size)
	{
		...
		while (current_secret)
		{
			...
			{
				current_a->content = current_secret->index;
				break ;
			}
...
void	secret_sort(t_stack_node **a, size_t a_size)
{
	...
	replace_values(a, &secret_stack, a_size);
	ft_lstclear(&secret_stack);
}
